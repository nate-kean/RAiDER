...
def make_points_0d_data():
    return (
        ...
        (1000.0, np.array([0.0, 0.0, 0.0]), np.array([0.0, 0.0, 1.0]), 5.0),
    )
...
def make_points_2d_data():
    ...
    slv[1, 0, 2] = 1
    slv[1, 1, 0] = -1
    make_points_args = (20.0, sp, slv, 5)
...
def make_points_3d_data():
    ...
    make_points_args = (100.0, sp, slv, 5)
...
def test_rio_extent() -> None:
    ...
    with rasterio.open(
        ...
        transform=rasterio.Affine.from_gdal(17.0, 0.1, 0, 18.0, 0, -0.1),
    ) as dst:
